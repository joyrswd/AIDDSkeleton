...
- Evaluate a finding and any proposed remedy independently. A valid finding does not make its proposed remedy authoritative, required, or in scope; reviewer or tool status does not grant decision or adoption authority.
