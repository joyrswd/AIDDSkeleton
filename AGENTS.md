...
- A change unit's scope is fixed when its work begins: it covers its approved AC and discovered work that Permission / Scope allows adding, while other discovered outcomes form follow-up units. Discovered work does not silently redefine the unit's AC.
