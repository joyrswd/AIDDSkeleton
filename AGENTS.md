...
- Before completing material work, perform adversarial self-review proportionate to the change and risk, aiming to disprove correctness rather than confirm it. Do not limit it to edited lines or the reported symptom: challenge assumptions, contradictions, causes/impact, boundaries/failure conditions, scope drift, and evidence/verification gaps across materially related same-responsibility, same-invariant, dependency, sibling-path, and failure-family surfaces. Stop the initial review when no materially new plausible surface remains within that proportional scope; do not repeat unchanged checks without a materially changed basis. Reopen the full proportional review when new evidence, failed verification, broad correction, or contradiction materially changes what must be examined; investigation does not expand modification authority.
...
- Treat material corrections as new adversarial surfaces. Challenge how the changed mechanism, fallback, boundary, assumption, dependency, or verification method can itself fail, partially fail, race, degrade, or bypass the protected outcome, and continue targeted review while materially new plausible failure surfaces remain; do not treat the correction itself as proof of resolution.
