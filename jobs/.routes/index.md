...
|---|---|---|
| Units / Placement | Work may create, classify, place, or restructure a job unit or its supporting material; determine whether jobs material is a job unit vs supporting material; determine file vs directory form; or decide whether material belongs inside a job. | `units-placement.md` |
