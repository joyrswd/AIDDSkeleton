...
- Reactivating a parent makes retained descendants discoverable again in their retained states; it does not alter descendant markers or re-fire descendant Hooks. Before relying on newly visible descendant state for continuation, reconcile that state against current parent control, dependencies, acceptance basis, and known evidence; this reconciliation does not itself rewrite descendant markers.
