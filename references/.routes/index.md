# Reference Material Governance Routes

`references/` owns durable **non-normative** material for future consultation: externally supplied originals and project-managed material with continuing evidential, diagnostic, maintenance, interoperability, audit, or re-investigation value.

Evaluate every route independently against the current action. Read every match before that action and re-evaluate when provenance, authority use, freshness, retention, or destination responsibility changes.
