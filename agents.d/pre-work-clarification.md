# Pre-Work Clarification Instructions

## Scope

- Applies only when dispatched by root `AGENTS.md` because a request has multiple material ambiguities.
- Inherits root governance.
