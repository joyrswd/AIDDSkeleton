# Consumer Regression Instructions

## Scope

- Applies only when dispatched by root `AGENTS.md` for Upstream-governance consumer regression or evaluation of whether a potentially breaking Upstream-governance change is generally adoptable.
- Inherits root governance. Consumer regression evaluates candidate Upstream governance; it neither adopts it nor authorizes Consumer changes.
