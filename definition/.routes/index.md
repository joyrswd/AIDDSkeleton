...
|---|---|---|
| Structure / Navigation / Procedures | Work initializes or changes definition structure; creates/moves/renames/deletes/reclassifies definition docs; determines definition ownership/placement; changes indexes/navigation/cross-responsibility routing; or creates/changes/classifies project procedures. | `structure.md` |
...
| Implementation Entry | Work is about to create/formalize a new implementation responsibility, start implementation for newly adopted/changed responsibility, or resume/start a formal implementation phase after a definition, blocker, or lifecycle-state change that may invalidate prior entry conditions. A local edit to an already-entered formal implementation/test does not match solely because it is formal. | `entry-completion.md` |
