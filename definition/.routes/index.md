...
|---|---|---|
| Structure / Navigation / Procedures | Work initializes or changes definition structure; creates/moves/renames/deletes/reclassifies definition docs; determines definition ownership/placement; changes indexes/navigation/cross-responsibility routing or document splitting; or creates/changes/classifies project procedures. | `structure.md` |
| Documentation Language | Work creates, adopts, or changes project-documentation content in `definition/`; determines or changes the documentation-language default/app override; or initializes documentation-language state. | `documentation-language.md` |
